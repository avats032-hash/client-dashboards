// Abundant Health Physical Medicine — Meta Ads Performance Dashboard
// Fetches a published Google Sheet CSV and renders KPI tiles + two interactive charts.

const CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSyJ06YGP1hDKaW5JQED96oKb2dkOSfNJHmjZVpnSF5CswUzj7sVTyyn0ZoYVJAvZ-27ynHK99ICbgk/pub?gid=321348547&single=true&output=csv";
...
function wireEvents() {
  ...
  // Status control is not rendered for this client: the published sheet carries no
  // "Campaign status" column, so filtering on it removed every row. Guarded rather
  // than deleted so the block drops straight back in if the column is ever added.
