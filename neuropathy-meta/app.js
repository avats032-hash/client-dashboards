// Neuropathy Elite Centers — Meta Ads Performance Dashboard
// Two ad accounts (Wisconsin + Green Bay) selectable via the Account dropdown.

const CSV_URLS = {
  "wisconsin": "https://docs.google.com/spreadsheets/d/e/2PACX-1vT0ikCKdpnod-90ZiJrIbUqG-a8nKMuI8sQT5oN-KIJkG5R5nja50Y2coognspSN9hFxw4cV1hS-zrq/pub?gid=167005066&single=true&output=csv",
  "green-bay": "https://docs.google.com/spreadsheets/d/e/2PACX-1vT0ikCKdpnod-90ZiJrIbUqG-a8nKMuI8sQT5oN-KIJkG5R5nja50Y2coognspSN9hFxw4cV1hS-zrq/pub?gid=1247922957&single=true&output=csv",
};
const ACCOUNT_LABELS = { "wisconsin": "Wisconsin", "green-bay": "Green Bay" };
let currentAccount = "wisconsin";
...
async function init(force = false) {
  ...
  try {
    const url = CSV_URLS[currentAccount] + (force ? "&_=" + Date.now() : "");
    document.getElementById("account-label").textContent =
      `Neuropathy Elite Centers — ${ACCOUNT_LABELS[currentAccount]} · campaign-level daily granularity`;
