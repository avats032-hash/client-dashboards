// Longmont Ortho — Meta Ads Performance Dashboard
// Fetches a published Google Sheet CSV and renders KPI tiles + two interactive charts.
// Sheet: https://docs.google.com/spreadsheets/d/1p7F0CrscFGk_Oj8JVKVmT-1nATzKRbD7euXiuHetV1s
// Tab: "Longmont Ortho" (gid=539942284)
// To get CSV_URL: File > Share > Publish to web > Longmont Ortho tab > CSV > copy link

const CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS50iEYQD-S8STcyWpP3v_QPogy9atdiACAXmBQfOY8jebV72s1ftkcft_tdNjYednWawr63r1flNVC/pub?gid=539942284&single=true&output=csv";
...
async function init(force = false) {
  ...
  try {
    ...
    document.getElementById("loading").innerHTML =
      `<p style="color:#dc2626;padding:20px">Error loading data: ${err.message}<br><small>If you see a CORS error, publish the sheet: File → Share → Publish to web → Longmont Ortho tab → CSV → update CSV_URL in app.js</small></p>`;
  }
}
