// Boca Manufacturing — Meta Ads Performance Dashboard
// Sheet: https://docs.google.com/spreadsheets/d/13QZIRLN5Ey2YnIKn4vj72kpMS4UqFyHjP0BRR3Pvebs
// Tab: "Boca Manufacturing" (gid=1875305843)

const CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQO5jyXaOgJqD4en7pr2qGDwDTLntxFtPEhmHGuR2X9mp46jws5FyiiHBbjamFPdv37ivw7XH1bKPUB/pub?gid=1875305843&single=true&output=csv";
...
async function init(force = false) {
  ...
  try {
    ...
    document.getElementById("loading").innerHTML =
      `<p style="color:#dc2626;padding:20px">Error loading data: ${err.message}<br><small>If you see a CORS error, publish the sheet: File → Share → Publish to web → Boca Manufacturing tab → CSV → update CSV_URL in app.js</small></p>`;
  }
}
