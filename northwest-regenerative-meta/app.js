// Northwest Center for Regenerative Medicine — Meta Ads Performance Dashboard
// Fetches a published Google Sheet CSV and renders KPI tiles + two interactive charts.
// Sheet: https://docs.google.com/spreadsheets/d/1mYYCqxrbujilD1IwZpXaY5QsbKSYlh-WxQQfSJkNbAk
...
async function init(force = false) {
  ...
  try {
    ...
    document.getElementById("loading").innerHTML =
      `<p style="color:#dc2626;padding:20px">Error loading data: ${err.message}<br><small>If you see a CORS error, publish the sheet: File → Share → Publish to web → Northwest Regenerative tab → CSV → update CSV_URL in app.js</small></p>`;
  }
}
